...
function UsuariosPageContent() {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        await Promise.all([loadVotacoesAtivas(), loadBetHistory(), loadBetCounts()]);
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-[radial-gradient(circle_at_top,_#dbeafe_0%,_#f8fafc_42%,_#f8fafc_100%)] flex items-center justify-center">
  ...
  return (
    ...
    >
      ...
      <header className="sticky top-0 z-30 border-b border-blue-500/40 bg-blue-600/95 shadow-md backdrop-blur" style={{ fontFamily: 'var(--font-poppins), sans-serif' }}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-2">
          ...
          <div className="relative flex items-center gap-2 sm:gap-3 min-w-0">
            ...
            {betHistoryOpen && (
              <div
                className="fixed inset-x-2 top-16 bottom-2 z-30 overflow-hidden rounded-3xl border border-blue-100 bg-white shadow-2xl sm:absolute sm:right-0 sm:top-14 sm:bottom-auto sm:inset-x-auto sm:w-[min(560px,calc(100vw-1rem))]"
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                ...
                <div className="h-[calc(100%-84px)] overflow-y-auto p-5 sm:max-h-[70vh] sm:h-auto">
                  {betHistoryError && (
            ...
            {profileOpen && (
              <div
                className="fixed inset-x-2 top-16 bottom-2 z-30 overflow-hidden rounded-3xl border border-blue-100 bg-white shadow-2xl sm:absolute sm:right-0 sm:top-14 sm:bottom-auto sm:inset-x-auto sm:w-[min(360px,calc(100vw-1rem))]"
                style={{ fontFamily: 'var(--font-poppins), sans-serif' }}
              >
                <div className="bg-blue-600 px-4 py-4 sm:px-5">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    <button
                      ...
                      className="rounded-full p-1.5 text-blue-100 transition hover:bg-blue-500 hover:text-white sm:hidden"
                ...
                <div className="h-[calc(100%-68px)] overflow-y-auto p-4 sm:h-auto sm:max-h-[70vh] sm:p-5">
      ...
      {/* Main Content */}
      <main className={depositOpen || withdrawOpen ? 'min-h-screen bg-gradient-to-b from-blue-600 to-blue-50 px-4 sm:px-6 py-6 sm:py-10' : 'mx-auto max-w-7xl px-4 sm:px-6 py-6 sm:py-10'}>
        {depositOpen ? (
          <>
          <div
          ...
          {betModal && (
            <div className="fixed inset-0 z-40 flex items-end justify-center bg-slate-900/70 backdrop-blur-sm p-0 sm:items-center sm:p-4">
              <div className="w-full overflow-hidden rounded-t-3xl border border-cyan-100 bg-white shadow-2xl sm:max-w-md sm:rounded-3xl">
                <div className="bg-gradient-to-r from-blue-600 via-blue-500 to-cyan-500 px-6 pb-5 pt-6 text-white">
                  ...
                  <p className="mt-3 text-base font-semibold text-white/95">{betModal.votacaoTitulo}</p>
                </div>

                <div className="p-6">
                  <div className="-mt-10 rounded-2xl border border-cyan-100 bg-gradient-to-br from-cyan-50 via-white to-blue-50 p-4 shadow-sm">
                    <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Candidato</p>
                    <div className="mt-2 flex items-center gap-3">
                      <div className="flex h-11 w-11 items-center justify-center overflow-hidden rounded-full border border-cyan-200 bg-white">
                        {betModal.imageUrl ? (
                          // eslint-disable-next-line @next/next/no-img-element
                      ...
                      <p className="text-lg font-bold text-slate-900">{betModal.candidato}</p>
                    </div>
                    <div className="mt-3 inline-flex rounded-full bg-gradient-to-r from-cyan-100 to-blue-100 px-3 py-1 text-sm font-extrabold tabular-nums text-cyan-900 ring-1 ring-cyan-200">
                      {betModal.odd.toFixed(2)}
                    </div>
                  </div>

                  <label className="mt-5 block text-sm font-medium text-slate-700">Valor da aposta</label>
                  <div className="mt-2 flex items-center rounded-xl border border-cyan-200 bg-cyan-50/50 px-3 py-2.5 focus-within:border-blue-500 focus-within:bg-white focus-within:ring-2 focus-within:ring-blue-100">
                    ...
                    <input
                      ...
                      placeholder="Ex: 25"
                      className="w-full border-0 bg-transparent px-2 text-base font-semibold text-slate-900 outline-none placeholder:text-slate-400"
                    />
                  </div>
                  ...
                  <div className="mt-3 grid grid-cols-2 gap-2 sm:grid-cols-4">
                    {[10, 25, 50, 100].map((value) => {
                      ...
                      return (
                        <button
                          ...
                          disabled={disabled}
                          className={`rounded-xl border px-3 py-2 text-sm font-bold tabular-nums transition ${
                            disabled
                    ...
                    {userBalance > 0 && (
                      <button
                        ...
                        className="col-span-2 rounded-xl border border-blue-200 bg-blue-50 px-3 py-2 text-sm font-semibold text-blue-700 transition hover:bg-blue-100 hover:shadow-sm sm:col-span-4"
                      >
                        Usar saldo máximo
                      </button>
                    )}
                  ...
                  <div className="mt-3 grid gap-2 rounded-xl border border-slate-200 bg-gradient-to-b from-slate-50 to-white p-3 text-xs sm:text-sm">
                  ...
                  <div className="mt-5 flex gap-2">
                    ...
                    <button
                      ...
                      disabled={placingBet}
                      className="flex-1 rounded-full bg-gradient-to-r from-blue-600 to-cyan-500 px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:from-blue-700 hover:to-cyan-600 disabled:opacity-60"
                    >
