            ...
            {filteredVotacoes.map((item) => {
              ...
              return (
                <div key={item.id} className="rounded-[28px] border border-slate-200 bg-white p-5 shadow-sm">
                  <div className="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
                    ...
                    <div className="flex flex-wrap gap-2 xl:justify-end">
                      <button
                        ...
                        className="rounded-full border border-cyan-200 px-4 py-2 text-sm font-semibold text-cyan-700 transition hover:bg-cyan-50 disabled:opacity-60"
                      >
                        Editar
                      </button>
                      <button
                  ...
                  <div className="mt-4 grid gap-3 rounded-[24px] bg-slate-50 p-4">
                      ...
                      >
                        <div className="flex items-center gap-3">
                          {option.imageUrl ? (
                            ...
                            <div className="flex h-16 w-16 items-center justify-center rounded-2xl border border-dashed border-slate-300 bg-slate-100 text-[11px] font-semibold text-slate-500">
                              IMG
                            </div>
                          )}
